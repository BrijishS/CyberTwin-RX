...
BASE_URL = os.getenv("CYBERTWIN_API_URL", DEFAULT_URL).rstrip("/")
...
class APIClient:
    ...
    def get_business_services(self) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/business-services", timeout=5)
            r.raise_for_status()
            return r.json()
    ...
    def get_assets(self) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/assets", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_vulnerabilities(self) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/vulnerabilities", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_security_controls(self) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/security-controls", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_risk_summary(self) -> Dict[str, Any]:
        try:
            r = requests.get(f"{self.base_url}/api/risk/summary", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_assets_risk(self) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/risk/assets", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_top_assets_risk(self, limit: int = 5) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/risk/top-assets?limit={limit}", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_digital_twin_graph(self) -> Dict[str, List[Dict[str, Any]]]:
        try:
            r = requests.get(f"{self.base_url}/api/digital-twin/graph", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_attack_paths(self) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/attack-paths", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_top_attack_path(self) -> Dict[str, Any]:
        try:
            r = requests.get(f"{self.base_url}/api/attack-paths/top", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def optimize_investment(self, budget: float) -> Dict[str, Any]:
        try:
            r = requests.post(f"{self.base_url}/api/optimizer/recommend", json={"budget": budget}, timeout=10)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def simulate_what_if(
        ...
        try:
            ...
            r = requests.post(f"{self.base_url}/api/simulation/what-if", json=payload, timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def simulate_portfolio(self, controls: List[Dict[str, Any]]) -> Dict[str, Any]:
        try:
            r = requests.post(f"{self.base_url}/api/simulation/portfolio", json={"controls": controls}, timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_ai_status(self) -> Dict[str, Any]:
        try:
            r = requests.get(f"{self.base_url}/api/ai/status", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_top_ml_threats(self, limit: int = 5) -> List[Dict[str, Any]]:
        try:
            r = requests.get(f"{self.base_url}/api/ai/top-threats?limit={limit}", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
    ...
    def get_ml_prediction(self, vulnerability_id: int) -> Dict[str, Any]:
        try:
            r = requests.get(f"{self.base_url}/api/ai/vulnerabilities/{vulnerability_id}", timeout=5)
            r.raise_for_status()
            return r.json()
        except Exception as e:
